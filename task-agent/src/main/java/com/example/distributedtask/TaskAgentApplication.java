    ...
    public CommandLineRunner run(RedisAgentService redisAgentService, ShellTaskExecutor shellTaskExecutor,
        ...
        return args -> {
            ...
            if (finalTaskState != null) {
                ...
                if (finalTaskState.getStatus() == Task.TaskStatus.SUCCESS &&
                    finalTaskState.getResult().contains("Task completed.")) {
                ...
                System.err.println("Could not retrieve task " + sampleTask.getTaskId() + " from Redis after processing.");
            }
